...
public class ArbolMViasBusqueda<K extends Comparable<K>,V>implements IArbolBusqueda<K,V>{
  ...
  private int altura(NodoMvias<K,V>nodoActual){
    ...
    public static void main(String ar[]) throws NullPointerException, ExcepcionOrdenInvalido, ExcepcionClaveNoExiste {
      ...
      //EJERCICIO 10
        arbolMV.insertar(3,"dilker");
        arbolMV.insertar(2,"deglis");
        arbolMV.insertar(1,"delgar");
        arbolMV.insertar(4,"dilker");
        arbolMV.insertar(5,"deglis");
        arbolMV.insertar(6,"delgar");
        arbolMV.insertar(7,"dilker");
        arbolMV.insertar(16,"deglis");
        arbolMV.insertar(15,"delgar");
        arbolMV.insertar(14,"deglis");
        arbolMV.insertar(13,"delgar");
        arbolMV.insertar(12,"delgar");
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        arbolMV.eliminar(14);
        //EJERCICIO 15
        System.out.println(arbolMV.NodosCompletosEnNivel(2));
        //EJERCICIO 17
        System.out.println(arbolMV.sonSimilares((ArbolMViasBusqueda<Integer, String>) arbol2));
    }
    }
